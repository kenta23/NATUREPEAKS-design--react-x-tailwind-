  ...
  return (
    <div className='flex p-8 w-full flex-col sm:flex-row gap-7 sm:gap-0 justify-around items-center bg-[#F3E1D0]' >
        ...
        <div className='flex flex-col gap-1 items-start justify-between'>
            <h1 className='text-[25px] sm:text-[30px] md:text-[35px] font-normal'>For more Information</h1>
            <p className='font-light text-[15px] sm:text-[20px] lg:text-[25px]'>Lorem ipsum dolor sit amet consectetur. Et in amet aliquam aenean et sit in potenti.</p>
